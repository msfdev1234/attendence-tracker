...
const Sidebar = () => {
	...
	return (
		<SidebarContainer collapsed={collapsed}>
			...
			<LinkContainer>
				<StyledLink to="/userdashboard/welcome" activeClassName="active">
					<FaHome /> {collapsed ? "" : "Dashboard"}
				</StyledLink>
				<StyledLink to="/userdashboard/my-courses" activeClassName="active">
					<FaBook /> {collapsed ? "" : "My Courses"}
				</StyledLink>
				<StyledLink to="/userdashboard/analytics" activeClassName="active">
					<FaChartBar /> {collapsed ? "" : "Analytics"}
				</StyledLink>
				<StyledLink to="/userdashboard/settings" activeClassName="active">
